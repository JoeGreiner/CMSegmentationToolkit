...
if __name__ == '__main__':
    ...
    path_xlsx_out = os.path.join(base_path, 'results', 'tables', 'cellpose_xy_evaluation.xlsx')
    prediction_folder = '/mnt/work/data/CM_Seg_Paper_24/results/cellpose_test_20250315-102911/one_model_xy_stitch_0.1_flow_0.4'
