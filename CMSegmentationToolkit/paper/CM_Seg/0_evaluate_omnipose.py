...
if __name__ == '__main__':
    ...
    path_xlsx_out = os.path.join(base_path, 'results', 'tables', 'omnipose_evaluation.xlsx')
    prediction_folder = '/mnt/work/data/CM_Seg_Paper_24/results/omnipose_test_20250315-122242/'
