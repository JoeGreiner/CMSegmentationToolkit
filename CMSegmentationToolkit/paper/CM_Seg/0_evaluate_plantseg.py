...
if __name__ == '__main__':
    ...
    path_xlsx_out = os.path.join(base_path, 'results', 'tables', 'plantseg_evaluation.xlsx')
    prediction_folder = '/mnt/work/data/CM_Seg_Paper_24/results/plantseg/2024_10_06_test/MultiCut_08/prediction_masked/'
